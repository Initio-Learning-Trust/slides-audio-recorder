...
Publisher: **Initio Learning**. A listing name may not contain "Google" or any Google product name,
which is why this is not "Audio Recorder for Google Slides".
...
Supplied by Initio's design handoff, in `assets/`:

| Asset | File | Size |
| --- | --- | --- |
| Application icon | `assets/app-icon-32.png` | 32×32 |
| Application icon | `assets/app-icon-128.png` | 128×128 |
| Application icon (other slots, if asked) | `assets/app-icon-16.png`, `-64`, `-256` | 16, 64, 256 |
| Source artwork | `assets/app-icon-1024.png` | 1024×1024 |
| Card banner | `assets/card-banner-220x140.png` | 220×140 |
...
1. **The sidebar idle**, beside a slide, showing the record button and the clips in the deck.
