...
The Insert ▸ Audio walkthrough needs no configuration: it is compiled into the add-on by the build.
See [design/WALKTHROUGH.md](design/WALKTHROUGH.md) to change it.
